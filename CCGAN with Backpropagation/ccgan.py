...
class CCGAN():
    def __init__(self):
        ...
        self.discriminator.compile(loss=['mse', 'categorical_crossentropy'],loss_weights=[0.5, 0.5],optimizer=optimizer,metrics=['accuracy'])
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        X_train = np.array([resize(x, [self.img_rows, self.img_cols]) for x in X_train])
        # Rescale -1 to 1
